...
function VendorManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingVendor) {
        ...
        const updateUrl = `/api/vendors/${editingVendor.id}`
  ...
  const handleDelete = async (vendorId) => {
    ...
    try {
      ...
      const url = `/api/vendors/${vendorId}`
  ...
  // Handle vendor selection for token management
  const handleManageTokens = (vendor) => {
    setSelectedVendor(vendor)
    setActiveTab('tokens')
  }
